...
1. [Функция main](lab5_scheme1.png)
2. [Функции заполнения массива и нахождения максимума на диагонали ](lab5_scheme2.png)
3. [Функция счётчик чисел больших чем максимум на диагонали](lab5_scheme3.png)
