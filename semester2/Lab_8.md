...
1. [Функция main](screenshots/lab8_scheme1.png)
2. [Функция удаления студентов, у которых средний балл оценок ниже заданного](screenshots/lab8_scheme2.png)
3. [Функция добавления студента, после заданного другого](screenshots/lab8_scheme3.png)
4. [Функция заполнения структуры данных "Студент"](screenshots/lab8_scheme4.png)
